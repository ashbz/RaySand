...
internal static unsafe class RlImGui
{
    ...
    static void ApplyStyle()
    {
        ...
        var c = s.Colors;
        c[(int)ImGuiCol.WindowBg]             = V(0.07f, 0.08f, 0.13f);
        c[(int)ImGuiCol.ChildBg]              = V(0.05f, 0.06f, 0.10f);
        c[(int)ImGuiCol.PopupBg]              = V4(0.07f, 0.08f, 0.13f, 0.98f);
        c[(int)ImGuiCol.TitleBg]              = V(0.04f, 0.05f, 0.09f);
        c[(int)ImGuiCol.TitleBgActive]        = V(0.08f, 0.12f, 0.24f);
        c[(int)ImGuiCol.TitleBgCollapsed]     = V(0.04f, 0.05f, 0.09f);
        c[(int)ImGuiCol.MenuBarBg]            = V(0.05f, 0.06f, 0.10f);
        c[(int)ImGuiCol.ScrollbarBg]          = V4(0.05f, 0.06f, 0.10f, 0.5f);
        c[(int)ImGuiCol.ScrollbarGrab]        = V(0.12f, 0.18f, 0.34f);
        c[(int)ImGuiCol.ScrollbarGrabHovered] = V(0.18f, 0.26f, 0.48f);
        c[(int)ImGuiCol.ScrollbarGrabActive]  = V(0.22f, 0.34f, 0.60f);
        c[(int)ImGuiCol.FrameBg]              = V(0.08f, 0.10f, 0.18f);
        c[(int)ImGuiCol.FrameBgHovered]       = V(0.10f, 0.14f, 0.24f);
        c[(int)ImGuiCol.FrameBgActive]        = V(0.09f, 0.12f, 0.20f);
        c[(int)ImGuiCol.Header]               = V4(0.10f, 0.18f, 0.38f, 0.75f);
        c[(int)ImGuiCol.HeaderHovered]        = V4(0.14f, 0.24f, 0.50f, 0.80f);
        c[(int)ImGuiCol.HeaderActive]         = V(0.12f, 0.22f, 0.44f);
        c[(int)ImGuiCol.Tab]                  = V4(0.07f, 0.10f, 0.22f, 0.86f);
        c[(int)ImGuiCol.TabHovered]           = V4(0.14f, 0.24f, 0.50f, 0.80f);
        c[(int)ImGuiCol.TabSelected]          = V(0.10f, 0.20f, 0.40f);
        c[(int)ImGuiCol.TabDimmed]            = V4(0.06f, 0.08f, 0.16f, 0.97f);
        c[(int)ImGuiCol.TabDimmedSelected]    = V(0.08f, 0.14f, 0.28f);
        c[(int)ImGuiCol.DockingPreview]       = V4(0.20f, 0.40f, 0.75f, 0.55f);
        c[(int)ImGuiCol.DockingEmptyBg]       = V(0.05f, 0.06f, 0.10f);
        c[(int)ImGuiCol.Button]               = V4(0.10f, 0.20f, 0.42f, 0.75f);
        c[(int)ImGuiCol.ButtonHovered]        = V(0.16f, 0.30f, 0.56f);
        c[(int)ImGuiCol.ButtonActive]         = V(0.08f, 0.16f, 0.34f);
        c[(int)ImGuiCol.CheckMark]            = V(0.35f, 0.60f, 1.00f);
        c[(int)ImGuiCol.SliderGrab]           = V(0.25f, 0.45f, 0.85f);
        c[(int)ImGuiCol.SliderGrabActive]     = V(0.35f, 0.58f, 0.95f);
        c[(int)ImGuiCol.Separator]            = V(0.12f, 0.16f, 0.28f);
        c[(int)ImGuiCol.SeparatorHovered]     = V4(0.18f, 0.30f, 0.58f, 0.78f);
        c[(int)ImGuiCol.SeparatorActive]      = V(0.20f, 0.36f, 0.65f);
        c[(int)ImGuiCol.ResizeGrip]           = V4(0.16f, 0.28f, 0.55f, 0.22f);
        c[(int)ImGuiCol.ResizeGripHovered]    = V4(0.22f, 0.38f, 0.70f, 0.67f);
        c[(int)ImGuiCol.ResizeGripActive]     = V4(0.22f, 0.38f, 0.70f, 0.95f);
        c[(int)ImGuiCol.Text]                 = V(0.88f, 0.90f, 0.96f);
        c[(int)ImGuiCol.TextDisabled]         = V(0.40f, 0.42f, 0.52f);
        c[(int)ImGuiCol.Border]               = V4(0.14f, 0.20f, 0.40f, 0.60f);
    }
