...
internal static unsafe class RlImGui
{
    ...
    public static void Begin()
    {
        ...
        foreach (var (rl, im) in _keys) io.AddKeyEvent(im, IsKeyDown(rl));
        int ch; while ((ch = GetCharPressed()) != 0) io.AddInputCharacter((uint)ch);
    ...
    public static void End()
    {
        ...
        if (clip != null && clip != _lastClip) { _lastClip = clip; SetClipboardText(clip); }
        ImGui.Render();
